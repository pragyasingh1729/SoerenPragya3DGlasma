...
//			 Observables::GaussLaw::CheckViolation(StringManipulation::StringCast("GVDynT",Dynamics::Time()));
    ...
    void Run(INT MPI_RNG_SEED){
	   ...
	   //SET LEFT SITTING NUCLEUS //0.75*Lattice::N[2]/2-1)
	//    CollidingObjects::SetWilsonLines(SUNcChargeDensity::rhoOldL,SUNcChargeDensity::rhoL,SUNcWilsonLines::VLeft,'L',0.75*Lattice::N[2]/2-1);
	   ...
	   //SET RIGHT SITTING NUCLEUS //1.25*Lattice::N[2]/2-1)
	//   CollidingObjects::SetWilsonLines(SUNcChargeDensity::rhoOldR,SUNcChargeDensity::rhoR,SUNcWilsonLines::VRight,'R',1.25*Lattice::N[2]/2-1);
