...
namespace SUNcGroup{
    ...
    namespace Operations{
        ...
        void trIGenU(SU_Nc_FUNDAMENTAL_FORMAT *V,COMPLEX *trItV){
            ...
            trItV[7]= DOUBLE(0.5)*ComplexI*(V[MatrixIndex(0,0)] + V[MatrixIndex(1,1)] - DOUBLE(2.0)*V[MatrixIndex(2,2)])/M_SQRT3;
        ...
        void ReTrIGenU(SU_Nc_FUNDAMENTAL_FORMAT *V,DOUBLE *RetrItV){
            ...
            RetrItV[7]=-DOUBLE(0.5)*(imag(V[MatrixIndex(0,0)]) + imag(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*imag(V[MatrixIndex(2,2)]))/M_SQRT3;
        }
        ...
        void ReTrIGenU(DOUBLE c,SU_Nc_FUNDAMENTAL_FORMAT *V,DOUBLE *RetrItV){
            ...
            RetrItV[7]=-c*DOUBLE(0.5)*(imag(V[MatrixIndex(0,0)]) + imag(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*imag(V[MatrixIndex(2,2)]))/M_SQRT3;
        }
        ...
        void ImTrIGenU(SU_Nc_FUNDAMENTAL_FORMAT *V,DOUBLE *ImtrItV){
            ...
            ImtrItV[7]= DOUBLE(0.5)*(real(V[MatrixIndex(0,0)]) + real(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*real(V[MatrixIndex(2,2)]))/M_SQRT3;
        ...
        void GetAdjoint(SU_Nc_FUNDAMENTAL_FORMAT *V,SU_Nc_ADJOINT_FORMAT *VAdj){
            ...
            VAdj[AdjIndex(0,7)]=real(V[MatrixIndex(1,0)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(1,1)]*conj(V[MatrixIndex(0,1)]) - DOUBLE(2.0)*V[MatrixIndex(1,2)]*conj(V[MatrixIndex(0,2)]))/M_SQRT3;
            ...
            VAdj[AdjIndex(1,7)]=imag(V[MatrixIndex(1,0)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(1,1)]*conj(V[MatrixIndex(0,1)]) - DOUBLE(2.0)*V[MatrixIndex(1,2)]*conj(V[MatrixIndex(0,2)]))/M_SQRT3;
            ...
            VAdj[AdjIndex(2,7)]=real(V[MatrixIndex(0,0)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(0,1)]*conj(V[MatrixIndex(0,1)]) - DOUBLE(2.0)*V[MatrixIndex(0,2)]*conj(V[MatrixIndex(0,2)]) - V[MatrixIndex(1,0)]*conj(V[MatrixIndex(1,0)]) - V[MatrixIndex(1,1)]*conj(V[MatrixIndex(1,1)]) + DOUBLE(2.0)*V[MatrixIndex(1,2)]*conj(V[MatrixIndex(1,2)]))/(DOUBLE(2.0)*M_SQRT3);
            ...
            VAdj[AdjIndex(3,7)]=real(V[MatrixIndex(2,0)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(2,1)]*conj(V[MatrixIndex(0,1)]) - DOUBLE(2.0)*V[MatrixIndex(2,2)]*conj(V[MatrixIndex(0,2)]))/M_SQRT3;
            ...
            VAdj[AdjIndex(4,7)]=imag(V[MatrixIndex(2,0)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(2,1)]*conj(V[MatrixIndex(0,1)]) - DOUBLE(2.0)*V[MatrixIndex(2,2)]*conj(V[MatrixIndex(0,2)]))/M_SQRT3;
            ...
            VAdj[AdjIndex(5,7)]=real(V[MatrixIndex(2,0)]*conj(V[MatrixIndex(1,0)]) + V[MatrixIndex(2,1)]*conj(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*V[MatrixIndex(2,2)]*conj(V[MatrixIndex(1,2)]))/M_SQRT3;
            ...
            VAdj[AdjIndex(6,7)]=imag(V[MatrixIndex(2,0)]*conj(V[MatrixIndex(1,0)]) + V[MatrixIndex(2,1)]*conj(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*V[MatrixIndex(2,2)]*conj(V[MatrixIndex(1,2)]))/M_SQRT3;
            
            VAdj[AdjIndex(7,0)]=real(V[MatrixIndex(0,1)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(1,1)]*conj(V[MatrixIndex(1,0)]) - DOUBLE(2.0)*V[MatrixIndex(2,1)]*conj(V[MatrixIndex(2,0)]))/M_SQRT3;
            
            VAdj[AdjIndex(7,1)]=imag(V[MatrixIndex(0,0)]*conj(V[MatrixIndex(0,1)])+ V[MatrixIndex(1,0)]*conj(V[MatrixIndex(1,1)]) + DOUBLE(2.0)*V[MatrixIndex(2,1)]*conj(V[MatrixIndex(2,0)]))/M_SQRT3;
            
            VAdj[AdjIndex(7,2)]=real(V[MatrixIndex(0,0)]*conj(V[MatrixIndex(0,0)]) - V[MatrixIndex(0,1)]*conj(V[MatrixIndex(0,1)]) + V[MatrixIndex(1,0)]*conj(V[MatrixIndex(1,0)]) - V[MatrixIndex(1,1)]*conj(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*V[MatrixIndex(2,0)]*conj(V[MatrixIndex(2,0)]) + DOUBLE(2.0)*V[MatrixIndex(2,1)]*conj(V[MatrixIndex(2,1)]))/(DOUBLE(2.0)*M_SQRT3);
            
            VAdj[AdjIndex(7,3)]=real(V[MatrixIndex(0,2)]*conj(V[MatrixIndex(0,0)]) + V[MatrixIndex(1,2)]*conj(V[MatrixIndex(1,0)]) - DOUBLE(2.0)*V[MatrixIndex(2,2)]*conj(V[MatrixIndex(2,0)]))/M_SQRT3;
            
            VAdj[AdjIndex(7,4)]=imag(V[MatrixIndex(0,0)]*conj(V[MatrixIndex(0,2)]) + V[MatrixIndex(1,0)]*conj(V[MatrixIndex(1,2)]) - DOUBLE(2.0)*V[MatrixIndex(2,0)]*conj(V[MatrixIndex(2,2)]))/M_SQRT3;
            
            VAdj[AdjIndex(7,5)]=real(V[MatrixIndex(0,2)]*conj(V[MatrixIndex(0,1)]) + V[MatrixIndex(1,2)]*conj(V[MatrixIndex(1,1)]) - DOUBLE(2.0)*V[MatrixIndex(2,2)]*conj(V[MatrixIndex(2,1)]))/M_SQRT3;
            
            VAdj[AdjIndex(7,6)]=imag(V[MatrixIndex(0,1)]*conj(V[MatrixIndex(0,2)]) + V[MatrixIndex(1,1)]*conj(V[MatrixIndex(1,2)]) - DOUBLE(2.0)*V[MatrixIndex(2,1)]*conj(V[MatrixIndex(2,2)]))/M_SQRT3;
