...
namespace LosAlamosAlgorithm{
    ...
    void UpdateGaugeTransformation(GaugeLinks *UOld,GaugeLinks *UNew,GaugeTransformations *G){
        ...
        UpdateGaugeTransformation(0,SUNcGaugeLinks::U->N[0]-1,0,SUNcGaugeLinks::U->N[1]-1,0,SUNcGaugeLinks::U->N[2]-1,CHECKERBOARD_EVEN_FLAG,UNew,G);
        GaugeTransformation::Operations::GaugeTransformLinks(UOld,UNew,G);
        
        UpdateGaugeTransformation(0,SUNcGaugeLinks::U->N[0]-1,0,SUNcGaugeLinks::U->N[1]-1,0,SUNcGaugeLinks::U->N[2]-1,CHECKERBOARD_ODD_FLAG,UNew,G);
        GaugeTransformation::Operations::GaugeTransformLinks(UOld,UNew,G);
